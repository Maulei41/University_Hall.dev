...
export const PEOPLE: Person[] = [
  ...
  { id: 'sa-Chairman', name: 'Woo Chi To 胡智滔', title: 'Chairman', bio: 'Section 2026-27', role: 'student-association' },
  { id: 'sa-IV', name: 'Chang Crispo Shun Man 鄭舜文', title: 'Internal Vice-Chairman', bio: 'Section 2026-27', role: 'student-association' },
  { id: 'sa-EV', name: 'Tam Tsz Ho 譚子皓', title: 'External Vice-Chairman', bio: 'Section 2026-27', role: 'student-association' },
  { id: 'sa-secretary', name: 'Pathak Atharv', title: 'Honorary Secretary', bio: 'Section 2026-27', role: 'student-association' },
  { id: 'sa-treasurer', name: 'Fu Chit Wa 符哲華', title: 'Honorary Treasurer', bio: 'Section 2026-27', role: 'student-association' },
  { id: 'sa-Financial', name: 'Ho Ka Kit', title: 'Financial Secretary', bio: 'Section 2026-27', role: 'student-association' },
  { id: 'sa-Welfare', name: 'Lam Max Yee Hong 林以康', title: 'Welfare Secretary ', bio: 'Section 2026-27', role: 'student-association' },
  { id: 'sa-Sports-Secretary', name: 'Kerem Bilgin', title: 'Sports Secretary ', bio: 'Section 2026-27', role: 'student-association' },
  { id: 'sa-Sports-Captain', name: 'Aktan Rakhat', title: 'Sports Captain ', bio: 'Section 2026-27', role: 'student-association' },
  { id: 'sa-Cultural', name: 'Zou Jiachen 邹佳辰', title: 'Cultural Secretary ', bio: 'Section 2026-27', role: 'student-association' },
  { id: 'sa-Social', name: 'Kemausuor Winambe Tetteh-Kumah', title: 'Social Secretary ', bio: 'Section 2026-27', role: 'student-association' },
  { id: 'sa-Publication', name: 'Chau Cheuk Hei 周倬希', title: 'Publication Secretary ', bio: 'Section 2026-27', role: 'student-association' },
  { id: 'sa-Publicity', name: 'Devanshu Gupta', title: 'Publicity Secretary ', bio: 'Section 2026-27', role: 'student-association' },
  { id: 'sa-AA', name: 'Huynh Duy Khoa', title: 'Alumni and Non-resident Affairs Secretary  ', bio: 'Section 2026-27', role: 'student-association' },
  { id: 'sa-CA', name: 'Karimli Yusuf', title: 'Current Affairs Secretary ', bio: 'Section 2026-27', role: 'student-association' },
  { id: 'sa-Past-Committee-Representative', name: 'Yu Pak Hin', title: 'Past Committee Representative ', bio: 'Section 2026-27', role: 'student-association' },
