...
export const PEOPLE: Person[] = [
  ...
  { id: 'sa-Chairman', name: 'Woo Chi To 胡智滔', title: 'Chairman — Students\' Association', bio: '', role: 'student-association' },
  { id: 'sa-IV', name: 'Chang Crispo Shun Man 鄭舜文', title: 'Internal Vice-Chairman — Students\' Association', bio: '', role: 'student-association' },
  { id: 'sa-EV', name: 'Tam Tsz Ho 譚子皓', title: 'External Vice-Chairman — Students\' Association', bio: '', role: 'student-association' },
  { id: 'sa-secretary', name: 'Pathak Atharv', title: 'Honorary Secretary — Students\' Association', bio: '', role: 'student-association' },
  { id: 'sa-treasurer', name: 'Fu Chit Wa 符哲華', title: 'Honorary Treasurer — Students\' Association', bio: '', role: 'student-association' },
  { id: 'sa-Financial', name: 'Ho Ka Kit', title: 'Financial Secretary — Students\' Association', bio: '', role: 'student-association' },
  { id: 'sa-Welfare', name: 'Lam Max Yee Hong 林以康', title: 'Welfare Secretary — Students\' Association', bio: '', role: 'student-association' },
  { id: 'sa-Sports-Secretary', name: 'Kerem Bilgin', title: 'Sports Secretary — Students\' Association', bio: '', role: 'student-association' },
  { id: 'sa-Sports-Captain', name: 'Aktan Rakhat', title: 'Sports Captain — Students\' Association', bio: '', role: 'student-association' },
  { id: 'sa-Cultural', name: 'Zou Jiachen 邹佳辰', title: 'Cultural Secretary — Students\' Association', bio: '', role: 'student-association' },
  { id: 'sa-Social', name: 'Kemausuor Winambe Tetteh-Kumah', title: 'Social Secretary — Students\' Association', bio: '', role: 'student-association' },
  { id: 'sa-Publication', name: 'Chau Cheuk Hei 周倬希', title: 'Publication Secretary — Students\' Association', bio: '', role: 'student-association' },
  { id: 'sa-Publicity', name: 'Devanshu Gupta', title: 'Publicity Secretary — Students\' Association', bio: '', role: 'student-association' },
  { id: 'sa-AA', name: 'Huynh Duy Khoa', title: 'Alumni and Non-resident Affairs Secretary  — Students\' Association', bio: '', role: 'student-association' },
  { id: 'sa-CA', name: 'Karimli Yusuf', title: 'Current Affairs Secretary — Students\' Association', bio: '', role: 'student-association' },
