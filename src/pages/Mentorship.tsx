        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              {quoVadis.imageSrc ? (
                <img
                  src={quoVadis.imageSrc}
                  alt="Quo Vadis — student mentorship project for multi-ethnic youth"
                  className="rounded-card shadow-xl relative w-full h-auto object-cover"
                />
              ) : (
                <ImagePlaceholder
                  width={16}
